...
namespace Frdp.Client.ScreenshotContainer.Factory.Duplicate
{
    ...
    public class DesktopFrame
    {
        ...
        /// <summary>
        ///     Returns the list of non-overlapping rectangles that indicate the areas of the desktop image that the operating
        ///     system updated since the last retrieved frame.
        /// </summary>
        /// <remarks>
        ///     To produce a visually accurate copy of the desktop, an application must first process all moved regions before it
        ///     processes updated regions.
        /// </remarks>
        public Rectangle[] UpdatedRegions
        {
            get;
            internal set;
        }
