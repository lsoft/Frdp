...
{
    public class WcfMainListener : IDisposable, IWCFListener
    {
            ...
            )
        {
            ...
            _serviceHost = new ServiceHost(typeof(WcfMainService), new Uri[] { });
            _serviceHost.AddServiceEndpoint(typeof(IWcfMainChannel), binding, endpointAddress.Uri);
